// lib/pdf/mappings/switzerland.ts

export const switzerlandCoordMap: Record<string, { x: number; y: number; page?: number }> = {
    ...
    "First Name": { x: 83, y: 788 },
    "Last Name": { x: 78, y: 597 },
    "Date of Birth": { x: 66, y: 963 },
    "Place of Birth": { x: 371, y: 897 },
    "Country of Birth": { x: 360, y: 1048 },
    "Nationality": { x: 618, y: 901 },
    "Gender": { x: 53, y: 1199 },
    "Marital Status": { x: 439, y: 1201 },
