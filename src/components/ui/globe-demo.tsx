...
export default function GlobeDemo() {
  ...
  // —— OPTIONAL: labels on top of the globe (country names) ——
  // You can extend this list or generate from your data.
  const countryLabels = [
    { lat: 48.8566, lng: 2.3522, text: "France" },
    { lat: 52.52,   lng: 13.405,  text: "Germany" },
    { lat: 52.3676, lng: 4.9041,  text: "Netherlands" },
    { lat: 41.9028, lng: 12.4964, text: "Italy" },
    { lat: 38.7369, lng: -9.1427, text: "Portugal" },
    { lat: 40.4168, lng: -3.7038, text: "Spain" },
    { lat: 37.9838, lng: 23.7275, text: "Greece" },
    { lat: 59.3293, lng: 18.0686, text: "Sweden" },
    { lat: 60.1699, lng: 24.9384, text: "Finland" },
    { lat: 38.7223, lng: -9.1393, text: "Lisbon" },
  ];

  const sampleArcs = [
    // (unchanged)  ← your arcs list from the prompt…
  ...
  return (
    <div className="flex flex-row items-center justify-center py-14 h-[28rem] md:h-[40rem] dark:bg-black bg-white relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 dark:text-neutral-200 max-w-xl mt-2 mx-auto">
            Interactive globe showing our worldwide reach. Hover and enjoy—more countries coming soon.
          </p>
        </motion.div>
